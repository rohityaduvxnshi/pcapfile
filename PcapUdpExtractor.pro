...
SOURCES += sources/AsterixUapRegistry.cpp
SOURCES += sources/AsterixDecoder.cpp
SOURCES += sources/AsterixCategoryPickerDialog.cpp
SOURCES += sources/AsterixFieldConfigurationDialog.cpp
...
HEADERS += headers/AsterixTypes.h
HEADERS += headers/AsterixUapRegistry.h
HEADERS += headers/AsterixDecoder.h
HEADERS += headers/AsterixCategoryPickerDialog.h
HEADERS += headers/AsterixFieldConfigurationDialog.h
...
FORMS += forms/AsterixCategoryPickerDialog.ui
FORMS += forms/AsterixFieldConfigurationDialog.ui
