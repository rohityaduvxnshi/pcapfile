...
const char* LIGHT_STYLE =
    ...
    "QToolTip{color:#F1F5F9;background-color:#1E293B;border:1px solid #334155;padding:5px 8px;font-size:9pt;}"
    ...
    "QLineEdit,QSpinBox,QDoubleSpinBox,QComboBox,QPlainTextEdit,QTextEdit{background-color:#FFFFFF;border:1px solid #D1D5DB;border-radius:8px;padding:4px 10px;min-height:22px;color:#111827;selection-background-color:#C7D2FE;selection-color:#1E1B4B;}"
...
const char* DARK_STYLE =
    ...
    "QToolTip{color:#E2E8F0;background-color:#0B1220;border:1px solid #334155;padding:5px 8px;font-size:9pt;}"
    ...
    "QLabel{background:transparent;}"
    "QLineEdit,QSpinBox,QDoubleSpinBox,QComboBox,QPlainTextEdit,QTextEdit{background-color:#0B1220;border:1px solid #334155;border-radius:8px;padding:4px 10px;min-height:22px;color:#E2E8F0;selection-background-color:#1E3A5F;selection-color:#E0F2FE;}"
